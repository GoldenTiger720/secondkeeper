    ...
    <div className="flex items-center gap-3 p-4 border rounded-lg group hover:bg-accent/50">
      <div className="relative h-16 w-16 flex-shrink-0">
        {imageUrl ? (
          ...
          <div className={cn("h-full w-full rounded-full flex items-center justify-center text-white", bgColor)}>
            <span className="font-medium text-xl">{name.charAt(0).toUpperCase()}</span>
          </div>
        )}
      </div>
    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <h1 className="text-2xl font-semibold tracking-tight">Authorized Faces</h1>
